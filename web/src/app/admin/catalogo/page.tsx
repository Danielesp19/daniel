...
/**
 * Un color por altura del árbol.
 *
 * Las tres alturas se veían casi iguales —filas blancas separadas por una
 * raya de un píxel— y con una sección abierta había que leer con atención
 * para saber de quién colgaba cada cosa. Ahora cada nivel tiene su barra y su
 * fondo, así que la estructura se entiende de un vistazo, sin leer.
 *
 * Terracota para las secciones (es el acento de la marca en el sitio) y azul
 * apagado para las subcategorías: dos tonos que se distinguen sin pelearse.
 * Los productos van en blanco, que es lo que los deja ser el contenido y no
 * otra carpeta más.
 */
const NIVEL = {
  seccion: { barra: "#C67139", fondo: "#FBF5F0" },
  subcategoria: { barra: "#4E7A8C", fondo: "#F1F6F8" },
} as const;
            ...
            >
              ...
              <header
                style={{
                  ...
                  // Ámbar si está oculta: se nota de un vistazo sin leer el
                  // rótulo.
                  borderLeft: `3px solid ${c.activa ? NIVEL.seccion.barra : COLOR.aviso}`,
                }}
              >
                <Flechas
                      ...
                      <div key={sub.id} style={{ borderTop: `1px solid ${COLOR.linea}` }}>
                        ...
                        <div
                          style={{
                            ...
                            marginLeft: 12,
                            borderLeft: `3px solid ${sub.activa ? NIVEL.subcategoria.barra : COLOR.aviso}`,
                            background: NIVEL.subcategoria.fondo,
                          }}
                        >
                          <Flechas
